...
static int sun6i_a31_pinctrl_probe(struct device_d *dev)
{
	return sunxi_pinctrl_init(dev, &sun6i_a31_pinctrl_data);
}
...
static struct driver_d sun6i_a31_pinctrl_driver = {
	.probe		= sun6i_a31_pinctrl_probe,
	.name		= "sun6i-a31-pinctrl",
	.of_compatible	= DRV_OF_COMPAT(sun6i_a31_pinctrl_match),
};

static int sun6i_a31_pinctrl_init(void)
{
	return platform_driver_register(&sun6i_a31_pinctrl_driver);
}
postcore_initcall(sun6i_a31_pinctrl_init);
