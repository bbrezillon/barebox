...
static int sun4i_a10_pinctrl_probe(struct device_d *dev)
{
	return sunxi_pinctrl_init(dev, &sun4i_a10_pinctrl_data);
}
...
static struct driver_d sun4i_a10_pinctrl_driver = {
	.probe		= sun4i_a10_pinctrl_probe,
	.name		= "sun4i-a10-pinctrl",
	.of_compatible	= DRV_OF_COMPAT(sun4i_a10_pinctrl_match),
};

static int sun4i_a10_pinctrl_init(void)
{
	return platform_driver_register(&sun4i_a10_pinctrl_driver);
}
postcore_initcall(sun4i_a10_pinctrl_init);
