...
static int sun7i_a20_pinctrl_probe(struct device_d *dev)
{
	return sunxi_pinctrl_init(dev, &sun7i_a20_pinctrl_data);
}
...
static struct driver_d sun7i_a20_pinctrl_driver = {
	.probe		= sun7i_a20_pinctrl_probe,
	.name		= "sun7i-a20-pinctrl",
	.of_compatible	= DRV_OF_COMPAT(sun7i_a20_pinctrl_match),
};

static int sun7i_a20_pinctrl_init(void)
{
	return platform_driver_register(&sun7i_a20_pinctrl_driver);
}
postcore_initcall(sun7i_a20_pinctrl_init);
