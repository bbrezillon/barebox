...
static int sun8i_a23_pinctrl_probe(struct device_d *dev)
{
	return sunxi_pinctrl_init(dev, &sun8i_a23_pinctrl_data);
}
...
static struct driver_d sun8i_a23_pinctrl_driver = {
	.probe		= sun8i_a23_pinctrl_probe,
	.name		= "sun8i-a23-pinctrl",
	.of_compatible	= DRV_OF_COMPAT(sun8i_a23_pinctrl_match),
};

static int sun8i_a23_pinctrl_init(void)
{
	return platform_driver_register(&sun8i_a23_pinctrl_driver);
}
postcore_initcall(sun8i_a23_pinctrl_init);
