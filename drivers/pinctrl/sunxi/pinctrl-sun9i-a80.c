...
static int sun9i_a80_pinctrl_probe(struct device_d *dev)
{
	return sunxi_pinctrl_init(dev, &sun9i_a80_pinctrl_data);
}
...
static struct driver_d sun9i_a80_pinctrl_driver = {
	.probe		= sun9i_a80_pinctrl_probe,
	.name		= "sun9i-a80-pinctrl",
	.of_compatible	= DRV_OF_COMPAT(sun9i_a80_pinctrl_match),
};

static int sun9i_a80_pinctrl_init(void)
{
	return platform_driver_register(&sun9i_a80_pinctrl_driver);
}
postcore_initcall(sun9i_a80_pinctrl_init);
