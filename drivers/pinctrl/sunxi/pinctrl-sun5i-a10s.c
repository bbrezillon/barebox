...
static int sun5i_a10s_pinctrl_probe(struct device_d *dev)
{
	return sunxi_pinctrl_init(dev, &sun5i_a10s_pinctrl_data);
}
...
static struct driver_d sun5i_a10s_pinctrl_driver = {
	.probe		= sun5i_a10s_pinctrl_probe,
	.name		= "sun5i-a10s-pinctrl",
	.of_compatible	= DRV_OF_COMPAT(sun5i_a10s_pinctrl_match),
};

static int sun5i_a10s_pinctrl_init(void)
{
	return platform_driver_register(&sun5i_a10s_pinctrl_driver);
}
postcore_initcall(sun5i_a10s_pinctrl_init);
