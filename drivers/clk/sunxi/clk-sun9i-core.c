...
static int __init sun9i_a80_pll4_setup(struct device_node *node)
{
	void __iomem *reg;
	...
	sunxi_factors_register(node, &sun9i_a80_pll4_data, reg);
	return 0;
}
...
static int __init sun9i_a80_gt_setup(struct device_node *node)
{
	void __iomem *reg;
	struct clk *gt;
	...
	gt = sunxi_factors_register(node, &sun9i_a80_gt_data, reg);
...
static int __init sun9i_a80_ahb_setup(struct device_node *node)
{
	void __iomem *reg;
	...
	sunxi_factors_register(node, &sun9i_a80_ahb_data, reg);
	return 0;
}
...
static int __init sun9i_a80_apb0_setup(struct device_node *node)
{
	void __iomem *reg;
	...
	sunxi_factors_register(node, &sun9i_a80_apb0_data, reg);
	return 0;
}
...
static int __init sun9i_a80_apb1_setup(struct device_node *node)
{
	void __iomem *reg;
	...
	sunxi_factors_register(node, &sun9i_a80_apb1_data, reg);
	return 0;
}
